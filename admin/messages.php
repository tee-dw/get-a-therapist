            ...
            <div class="recent-updates">
                ...
                <div class="updates">
                    ...
                    <div class="update">
                        ...
                        <div class="message">
                            <p><b><?php print $msg['firstname'] . ' ' . $msg['lastname']; ?></b> with the email address: <b><?php print $msg['email'] ?></b> just sent a message through the contact form. They said, <b><?php print '"' . $msg['messages'] . '"'?></b></p>
                            <small class="text-muted"><i><?php print $msg['date_posted'] ?></i></small><button type="button" class="send-email" style="margin-top: 0.5rem;">Send email</button>
                        </div>
                    </div>
